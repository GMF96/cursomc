...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.apis(RequestHandlerSelectors
						.basePackage("com.gustavo.cursomc.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API do curso Spring Boot", "Esta API é utilizada no curso de Spring Boot", "Versão 1.0",
				"https://www.udemy.com/terms", new Contact("Gustavo", "", ""), "Permitido uso para estudantes",
				"https://www.udemy.com/terms", Collections.emptyList() // Vendor Extensions
		);
	}
