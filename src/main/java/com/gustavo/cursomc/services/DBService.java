...
public class DBService {
	...
	public void intantiateTestDatabase() throws ParseException {
		...
		Cliente cli2 = new Cliente(null, "Ana Costa", "ana@gmail.com", "04261810000", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("27399923", "938345393"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 203", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2105", null, "Centro", "38764012", cli2, c2);
